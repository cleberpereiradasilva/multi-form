      ...
      <Content>
        <div className="sm:pr-30">
          ...
          <div className="pt-6">
            ...
            <div className="bg-blue-50 rounded-lg h-10 m-2 font-bold flex justify-center items-center">
              <span className={`${period === 1 ? "text-blue-marine" : ""}`}>
                Monthly
              </span>
              <div className="w-20 text-center">
                ...
                >
                  <Switch.Thumb
                    ...
                    className={`w-3 h-3 ${
                      period == 1 ? "translate-x-[4px]" : "translate-x-[27px]"
